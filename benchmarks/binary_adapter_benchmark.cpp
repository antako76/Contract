...
struct BenchNumericHooked {
    ...
    int contract_get(contract::tag<field::id>) const {
        return id;
    }

    template<class Value>
    void contract_set(contract::tag<field::id>, Value&& value) {
        id = static_cast<std::uint64_t>(std::forward<Value>(value));
    }

    std::uint32_t contract_get(contract::tag<field::count>) const {
        return count;
    }
    ...
    double contract_get(contract::tag<field::ratio>) const {
        return ratio;
    }

    template<class Value>
    void contract_set(contract::tag<field::ratio>, Value&& value) {
        ratio = static_cast<double>(std::forward<Value>(value));
    }

    std::uint64_t contract_get(contract::tag<field::total>) const {
        return total;
    }

    template<class Value>
    void contract_set(contract::tag<field::total>, Value&& value) {
...
struct BenchStringHooked {
    ...
    decltype(auto) contract_get(contract::tag<field::name>) const {
        return (name);
    }
};
...
struct BenchCStringHooked {
    ...
    decltype(auto) contract_get(contract::tag<field::category>) const {
        return category;
    }
};
...
struct BenchCharArrayHooked##SUFFIX { \
 ...
 \
    template<class Value> \
    void contract_set(contract::tag<field::tag>, Value&& value) { \
        std::memcpy(tag, std::forward<Value>(value), sizeof(tag)); \
    } \
 \
    decltype(auto) contract_get(contract::tag<field::tag>) const { \
        return (tag); \
    } \
};
...
struct BenchRequestEventHooked : BenchRequestBase {
    ...
    template<class Value>
    void contract_set(contract::tag<BenchRequestBase::field::timestamp>, Value&& value) {
        timestamp = static_cast<std::uint64_t>(std::forward<Value>(value));
    }

    template<class Value>
    void contract_set(contract::tag<BenchRequestBase::field::service>, Value&& value) {
        service = static_cast<std::uint64_t>(std::forward<Value>(value));
    }

    template<class Value>
    void contract_set(contract::tag<field::user_id>, Value&& value) {
        user_id = static_cast<std::uint64_t>(std::forward<Value>(value));
    }

    decltype(auto) contract_get(contract::tag<BenchRequestBase::field::timestamp>) const {
        return timestamp;
    }

    decltype(auto) contract_get(contract::tag<BenchRequestBase::field::service>) const {
        return service;
    }

    decltype(auto) contract_get(contract::tag<field::user_id>) const {
        return user_id;
    }
};
...
struct BenchRoutedEventHooked : BenchRequestBase, BenchTraceContext {
    ...
    template<class Value>
    void contract_set(contract::tag<BenchTraceContext::field::trace_id>, Value&& value) {
        trace_id = static_cast<std::uint64_t>(std::forward<Value>(value));
    }

    template<class Value>
    void contract_set(contract::tag<field::route_id>, Value&& value) {
    ...
    decltype(auto) contract_get(contract::tag<BenchTraceContext::field::trace_id>) const {
        return trace_id;
    }

    decltype(auto) contract_get(contract::tag<field::route_id>) const {
        return route_id;
    }
};
...
struct BenchVectorHooked {
    ...
    template<class Value>
    void contract_set(contract::tag<field::values>, Value&& value) {
        values = std::forward<Value>(value);
    }

    decltype(auto) contract_get(contract::tag<field::values>) const {
        return (values);
    }
};
...
struct BenchTupleHooked {
    ...
    template<class Value>
    void contract_set(contract::tag<field::payload>, Value&& value) {
        payload = std::forward<Value>(value);
    }

    decltype(auto) contract_get(contract::tag<field::payload>) const {
        return (payload);
    }
};
...
struct BenchMapHooked {
    ...
    template<class Value>
    void contract_set(contract::tag<field::labels>, Value&& value) {
        labels = std::forward<Value>(value);
    }

    decltype(auto) contract_get(contract::tag<field::labels>) const {
        return (labels);
    }
};
...
struct BenchOptionalHooked {
    ...
    decltype(auto) contract_get(contract::tag<field::count>) const {
        return (count);
    }
};
...
struct BenchBitsetHooked##SUFFIX { \
 ...
 \
    template<class Value> \
    void contract_set(contract::tag<field::flags>, Value&& value) { \
        flags = std::forward<Value>(value); \
    } \
 \
    decltype(auto) contract_get(contract::tag<field::flags>) const { \
        return (flags); \
    } \
}; \
...
CONTRACT_NOINLINE void exercise_hooked_fixtures(volatile std::uint64_t& sink) {
    ...
    numeric.contract_set(contract::tag<BenchNumericHooked::field::id>{}, 101u);
    numeric.contract_set(contract::tag<BenchNumericHooked::field::count>{}, 43u);
    numeric.contract_set(contract::tag<BenchNumericHooked::field::ratio>{}, 4.25);
    numeric.contract_set(contract::tag<BenchNumericHooked::field::total>{}, 9001u);
    sink += numeric.contract_get(contract::tag<BenchNumericHooked::field::id>{});
    sink += numeric.contract_get(contract::tag<BenchNumericHooked::field::count>{});
    sink += static_cast<std::uint64_t>(numeric.contract_get(contract::tag<BenchNumericHooked::field::ratio>{}));
    sink += numeric.contract_get(contract::tag<BenchNumericHooked::field::total>{});

    BenchStringHooked string_hooked;
    string_hooked.contract_set(contract::tag<BenchStringHooked::field::name>{}, std::string("hooked"));
    sink += string_hooked.contract_get(contract::tag<BenchStringHooked::field::name>{}).size();

    std::string_view view_storage = "hooked-view";
    BenchStringViewHooked view_hooked;
    view_hooked.contract_set(contract::tag<BenchStringViewHooked::field::name>{}, view_storage);
    sink += view_hooked.contract_get(contract::tag<BenchStringViewHooked::field::name>{}).size();

    const char* cstring_storage = "hooked-cstr";
    BenchCStringHooked cstring_hooked;
    cstring_hooked.contract_set(contract::tag<BenchCStringHooked::field::category>{}, cstring_storage);
    sink += std::char_traits<char>::length(cstring_hooked.contract_get(contract::tag<BenchCStringHooked::field::category>{}));

    BenchCharArrayHooked8 char8;
    char8.contract_set(contract::tag<BenchCharArrayHooked8::field::tag>{}, make_char_payload<8>('h').data());
    sink += static_cast<unsigned char>(char8.contract_get(contract::tag<BenchCharArrayHooked8::field::tag>{})[0]);

    BenchCharArrayHooked1000 char1000;
    char1000.contract_set(contract::tag<BenchCharArrayHooked1000::field::tag>{}, make_char_payload<1000>('h').data());
    sink += static_cast<unsigned char>(char1000.contract_get(contract::tag<BenchCharArrayHooked1000::field::tag>{})[0]);

    BenchRequestEventHooked request;
    request.contract_set(contract::tag<BenchRequestBase::field::timestamp>{}, 8u);
    request.contract_set(contract::tag<BenchRequestBase::field::service>{}, 12u);
    request.contract_set(contract::tag<BenchRequestEventHooked::field::user_id>{}, 43u);
    sink += request.contract_get(contract::tag<BenchRequestBase::field::timestamp>{});
    sink += request.contract_get(contract::tag<BenchRequestBase::field::service>{});
    sink += request.contract_get(contract::tag<BenchRequestEventHooked::field::user_id>{});

    BenchRoutedEventHooked routed;
    routed.contract_set(contract::tag<BenchRequestBase::field::timestamp>{}, 8u);
    routed.contract_set(contract::tag<BenchRequestBase::field::service>{}, 12u);
    routed.contract_set(contract::tag<BenchTraceContext::field::trace_id>{}, 6u);
    routed.contract_set(contract::tag<BenchRoutedEventHooked::field::route_id>{}, 10u);
    sink += routed.contract_get(contract::tag<BenchRequestBase::field::timestamp>{});
    sink += routed.contract_get(contract::tag<BenchRequestBase::field::service>{});
    sink += routed.contract_get(contract::tag<BenchTraceContext::field::trace_id>{});
    sink += routed.contract_get(contract::tag<BenchRoutedEventHooked::field::route_id>{});

    BenchVectorHooked vector;
    vector.contract_set(contract::tag<BenchVectorHooked::field::values>{}, std::vector<std::uint32_t>{7, 8, 9, 10});
    sink += vector.contract_get(contract::tag<BenchVectorHooked::field::values>{})[0];

    BenchArrayHooked4 array4;
    array4.contract_set(contract::tag<BenchArrayHooked4::field::values>{}, std::array<std::uint32_t, 4>{9, 10, 11, 12});
    sink += array4.contract_get(contract::tag<BenchArrayHooked4::field::values>{})[0];

    BenchTupleHooked tuple;
    tuple.contract_set(contract::tag<BenchTupleHooked::field::payload>{}, std::tuple<std::uint32_t, std::string, std::array<std::uint32_t, 3>>{
        19,
        "tuple-alt",
        {7, 8, 9}
    });
    sink += std::get<0>(tuple.contract_get(contract::tag<BenchTupleHooked::field::payload>{}));

    BenchVariantHooked variant;
    variant.contract_set(contract::tag<BenchVariantHooked::field::payload>{}, std::array<std::uint32_t, 3>{4, 5, 6});
    ...
    }, variant.contract_get(contract::tag<BenchVariantHooked::field::payload>{}));

    BenchMapHooked map;
    map.contract_set(contract::tag<BenchMapHooked::field::labels>{}, make_label_map<std::map<std::uint32_t, std::string>>(2, 9, 8));
    sink += map.contract_get(contract::tag<BenchMapHooked::field::labels>{}).size();

    BenchOptionalHooked optional;
    optional.contract_set(contract::tag<BenchOptionalHooked::field::count>{}, std::optional<std::uint32_t>{44});
    sink += optional.contract_get(contract::tag<BenchOptionalHooked::field::count>{}).value_or(0);

    BenchBitsetHooked10 bitset10;
    bitset10.contract_set(contract::tag<BenchBitsetHooked10::field::flags>{}, std::bitset<10>{0x155});
    sink += bitset10.contract_get(contract::tag<BenchBitsetHooked10::field::flags>{}).count();

    BenchBitsetHooked100 bitset100;
    bitset100.contract_set(contract::tag<BenchBitsetHooked100::field::flags>{}, std::bitset<100>{0x5555});
    sink += bitset100.contract_get(contract::tag<BenchBitsetHooked100::field::flags>{}).count();

    BenchUnorderedMapHooked unordered;
    unordered.contract_set(contract::tag<BenchUnorderedMapHooked::field::labels>{}, make_label_map<std::unordered_map<std::uint32_t, std::string>>(2, 17, 8));
    sink += unordered.contract_get(contract::tag<BenchUnorderedMapHooked::field::labels>{}).size();
}
